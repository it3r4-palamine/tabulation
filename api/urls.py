...
urlpatterns = [
    ...
    url(r'^course/get/(?P<uuid>[\w\-]+)$', course.CourseAPIView.as_view()),
    ...
    url(r'^question/upload_question_image/$', question.write_question_image),
    ...
    url(r'^student_answers/clear_all/$', student_answers.clear_all_answers),
