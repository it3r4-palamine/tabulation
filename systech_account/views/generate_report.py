...
def generate(request):
	try:
		...
		new_folder = os.path.join('systech_account'+settings.STATIC_URL, 'reports')
		...
		prs.save('systech_account'+settings.STATIC_URL+'reports/'+company_assessment.reference_no+' - '+company_assessment.company.name+'.pptx')
...
def delete_report(request):
	try:
		...
		if os.path.exists('systech_account'+data['link']):
			os.remove('systech_account'+data['link'])
		else:
